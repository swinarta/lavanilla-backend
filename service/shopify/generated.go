...
// GetName returns DraftOrderCompleteDraftOrderCompleteDraftOrderCompletePayloadDraftOrder.Name, and is useful for accessing the field via an interface.
func (v *DraftOrderCompleteDraftOrderCompleteDraftOrderCompletePayloadDraftOrder) GetName() string {
	return v.Name
}
...
// DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload includes the requested fields of the GraphQL type DraftOrderUpdatePayload.
// The GraphQL type's documentation follows.
//
// Return type for `draftOrderUpdate` mutation.
type DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload struct {
	// The updated draft order.
	DraftOrder DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder `json:"draftOrder"`
	// The list of errors that occurred from executing the mutation.
	UserErrors []DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError `json:"userErrors"`
}

// GetDraftOrder returns DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload.DraftOrder, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload) GetDraftOrder() DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder {
	return v.DraftOrder
}

// GetUserErrors returns DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload.UserErrors, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload) GetUserErrors() []DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError {
	return v.UserErrors
}

// DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder includes the requested fields of the GraphQL type DraftOrder.
// The GraphQL type's documentation follows.
//
// An order that a merchant creates on behalf of a customer. Draft orders are
// useful for merchants that need to do the following tasks:
...
//
// Draft orders created on or after April 1, 2025 will be automatically purged after one year of inactivity.
type DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder struct {
	// A globally-unique ID.
	Id string `json:"id"`
}

// GetId returns DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder.Id, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadDraftOrder) GetId() string {
	return v.Id
}

// DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError includes the requested fields of the GraphQL type UserError.
// The GraphQL type's documentation follows.
//
// Represents an error in the input of a mutation.
type DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError struct {
	// The error message.
	Message string `json:"message"`
	// The path to the input field that caused the error.
	Field []string `json:"field"`
...
// GetMessage returns DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError.Message, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError) GetMessage() string {
	return v.Message
}

// GetField returns DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError.Field, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayloadUserErrorsUserError) GetField() []string {
	return v.Field
}

// DraftOrderLineItemCustomAttributesAddResponse is returned by DraftOrderLineItemCustomAttributesAdd on success.
type DraftOrderLineItemCustomAttributesAddResponse struct {
	...
	// created.
	DraftOrderUpdate DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload `json:"draftOrderUpdate"`
}

// GetDraftOrderUpdate returns DraftOrderLineItemCustomAttributesAddResponse.DraftOrderUpdate, and is useful for accessing the field via an interface.
func (v *DraftOrderLineItemCustomAttributesAddResponse) GetDraftOrderUpdate() DraftOrderLineItemCustomAttributesAddDraftOrderUpdateDraftOrderUpdatePayload {
...
// __DraftOrderLineItemCustomAttributesAddInput is used internally by genqlient
type __DraftOrderLineItemCustomAttributesAddInput struct {
...
// GetDraftOrderId returns __DraftOrderLineItemCustomAttributesAddInput.DraftOrderId, and is useful for accessing the field via an interface.
func (v *__DraftOrderLineItemCustomAttributesAddInput) GetDraftOrderId() string {
	return v.DraftOrderId
}

// GetVariantId returns __DraftOrderLineItemCustomAttributesAddInput.VariantId, and is useful for accessing the field via an interface.
func (v *__DraftOrderLineItemCustomAttributesAddInput) GetVariantId() string { return v.VariantId }

// GetQty returns __DraftOrderLineItemCustomAttributesAddInput.Qty, and is useful for accessing the field via an interface.
func (v *__DraftOrderLineItemCustomAttributesAddInput) GetQty() int { return v.Qty }

// GetKey returns __DraftOrderLineItemCustomAttributesAddInput.Key, and is useful for accessing the field via an interface.
func (v *__DraftOrderLineItemCustomAttributesAddInput) GetKey() string { return v.Key }

// GetValue returns __DraftOrderLineItemCustomAttributesAddInput.Value, and is useful for accessing the field via an interface.
func (v *__DraftOrderLineItemCustomAttributesAddInput) GetValue() string { return v.Value }
...
// The mutation executed by DraftOrderLineItemCustomAttributesAdd.
const DraftOrderLineItemCustomAttributesAdd_Operation = `
mutation DraftOrderLineItemCustomAttributesAdd ($draftOrderId: ID!, $variantId: ID!, $qty: Int!, $key: String!, $value: String!) {
	draftOrderUpdate(id: $draftOrderId, input: {lineItems:[{variantId:$variantId,quantity:$qty,customAttributes:{key:$key,value:$value}}]}) {
		draftOrder {
			id
		}
		userErrors {
...
func DraftOrderLineItemCustomAttributesAdd(
	ctx_ context.Context,
	client_ graphql.Client,
	draftOrderId string,
	variantId string,
	...
	key string,
	value string,
) (data_ *DraftOrderLineItemCustomAttributesAddResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "DraftOrderLineItemCustomAttributesAdd",
		Query:  DraftOrderLineItemCustomAttributesAdd_Operation,
		Variables: &__DraftOrderLineItemCustomAttributesAddInput{
	...
	data_ = &DraftOrderLineItemCustomAttributesAddResponse{}
	resp_ := &graphql.Response{Data: data_}
