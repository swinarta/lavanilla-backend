...
type ComplexityRoot struct {
	...
	Query struct {
		Files        func(childComplexity int, draftOrderID string, uploadToken string) int
...
type QueryResolver interface {
	...
	Files(ctx context.Context, draftOrderID string, uploadToken string) ([]*model.File, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.files":
		...
		return e.complexity.Query.Files(childComplexity, args["draftOrderId"].(string), args["uploadToken"].(string)), true
...
func (ec *executionContext) _Query_files(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Query().Files(ctx, fc.Args["draftOrderId"].(string), fc.Args["uploadToken"].(string))
		},
		nil,
		ec.marshalOFile2ᚕᚖlavanillaᚋgraphqlᚋselfᚑqueueᚋmodelᚐFileᚄ,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalNFile2ᚖlavanillaᚋgraphqlᚋselfᚑqueueᚋmodelᚐFile(ctx context.Context, sel ast.SelectionSet, v *model.File) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOFile2ᚕᚖlavanillaᚋgraphqlᚋselfᚑqueueᚋmodelᚐFileᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.File) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNFile2ᚖlavanillaᚋgraphqlᚋselfᚑqueueᚋmodelᚐFile(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
